...
namespace InventorEvents2010.Interfaces
{
    public interface IApplicationEventsLib
    {
        ...
        { get; set; }
        ApplicationEventsSink_OnCloseViewEventHandler OnCloseViewDelegate { get; set; }
        ApplicationEventsSink_OnDeactivateDocumentEventHandler
            OnDeactivateDocumentDelegate { get; set; }
        ...
        { get; set; }
        ApplicationEventsSink_OnNewViewEventHandler OnNewViewDelegate { get; set; }
        ApplicationEventsSink_OnOpenDocumentEventHandler OnOpenDocumentDelegate
        { get; set; }
        ApplicationEventsSink_OnQuitEventHandler OnQuitDelegate { get; set; }
        ApplicationEventsSink_OnReadyEventHandler OnReadyDelegate { get; set; }
